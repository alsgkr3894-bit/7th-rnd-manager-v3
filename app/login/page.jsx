    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: 28 }}>
          <div style={{
            ...
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none"
              ...
              <circle cx="10" cy="10" r="1"/><circle cx="14" cy="13" r="1"/>
            </svg>
          </div>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontWeight: 700, fontSize: 14, color: 'var(--text-1)' }}>{profile.name || '사용자'}</div>
            <div style={{ fontSize: 12, color: 'var(--text-3)' }}>{profile.team || profile.role || ''}</div>
          </div>
        </div>
