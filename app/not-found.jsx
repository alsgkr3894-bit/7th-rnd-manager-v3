    ...
    <div className={styles.root}>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.errorNum} role="img" aria-label="404 오류">
          <span aria-hidden="true" className={`${styles.digit} ${styles.digitOutline}`}>
            4
          </span>
          <span aria-hidden="true" className={`${styles.digit} ${styles.digitFill}`}>
            0
          </span>
          <span
            aria-hidden="true"
            className={`${styles.digit} ${styles.digitOutline} ${styles.digitLast}`}
          >
            4
          </span>
        </div>
        ...
        <p className={styles.desc}>
          요청하신 페이지가 삭제되었거나 다른 곳으로 이동되었어요.
          <br />
