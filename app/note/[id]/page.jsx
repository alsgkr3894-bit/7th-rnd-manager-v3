    ...
    initDB()
      ...
      .then(([note, ch, allSamples]) => {
        ...
        if (note.menuName) {
          ...
          setRelatedSamples(
            allSamples.filter(s => sampleNamesOf(s).some(n => n.trim().toLowerCase() === mn))
          );
        }
  ...
  return (
    <main className="main">
      <PageHeader
        ...
        actions={
          <>
            <button className="btn no-print" onClick={handlePrint} title="인쇄">
              🖨
            </button>
            <button
            ...
            <div style={{ position: 'relative' }} className="no-print">
              <button className="btn" onClick={() => setCostMenuOpen(v => !v)}>
                ↗ 원가
              </button>
              {costMenuOpen && (
                <>
            ...
            <button className="btn no-print" onClick={handleCreateSample}>
              📷 샘플 작성
            </button>
            <button className="btn no-print" onClick={handleCancel}>
              취소
            </button>
