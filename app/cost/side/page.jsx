'use client';
import { getSideRecipeMap, upsertSideRecipe, deleteSideRecipe, sideTotalCost } from '@/lib/cost/side-detail';
...
export default function Page() {
  ...
  return (
    <CostDetailView
      ...
      emptyHint={<>메뉴 마스터에서 기본 코드를 등록하고 판매가로 내보내기를 실행하세요 (예: <code>S-CHK-001</code>, <code>S-SPG-001</code>).</>}
      footerLabel="원가 합계"
