...
export async function getCostAlertData() {
  ...
  for (const r of recipes) {
    ...
    items.push({
      menuName: asDisplayText(r.menuName, '메뉴명 없음'),
      menuCategory: asDisplayText(r.menuCategory, '기타'),
