 ...
 */
import { getBrandById, getDefaultBrandId, getVisibleBrands } from '@/lib/brand-master';
...
export function getActiveBrandId() {
  ...
  try {
    ...
    return v && getBrandById(v) ? v : getDefaultBrandId();
  } catch {
...
export function setActiveBrandId(id) {
  ...
  if (!getBrandById(id)) return false;
  try {
...
export function getActiveBrand() {
  ...
  return getBrandById(id) || getVisibleBrands()[0] || getBrandById(DEFAULT_BRAND, { includeHidden: true });
}
