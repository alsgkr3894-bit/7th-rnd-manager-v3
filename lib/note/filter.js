...
export function filterSortNotes(notes, {
  ...
  return [...list].sort((a, b) => {
    ...
    if (sortBy === 'menuName') return asDisplayText(a.menuName).localeCompare(asDisplayText(b.menuName), 'ko');
    if (sortBy === 'testDate') return asDisplayText(b.testDate).localeCompare(asDisplayText(a.testDate));
