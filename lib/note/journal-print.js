    ...
    .map((note, idx) => {
      ...
      <article class="report-card">
        ...
        <div class="report-meta">
          ${note.testDate ? `<span><b>작성일</b> ${esc(note.testDate)}</span>` : ''}
...
<body>
  <div class="doc-header">
    <div>
      <div class="doc-title">오늘 한 일 보고서</div>
  ...
  <div class="summary-row">
    <div class="summary-cell"><span class="summary-label">작성일</span>${esc(dateLabel)}</div>
