...
function scaleNutritionByAmount(raw, amount) {
  ...
  const factor = Number.isFinite(basisWeight) && basisWeight > 0 ? grams / basisWeight : grams / 100;
...
function buildIngredientAdditionSumForSide(comp, ingredientNutritionMap, side) {
