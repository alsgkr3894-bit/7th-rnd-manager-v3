/**
 * lib/nutrition/label/print.js — 영양성분표 PDF(인쇄) 출력 (5시트)
 */
...
function simpleHtml(title, rows) {
...
export function printNutritionLabelAll({ pizzaSheet, toppingSheet, sideSheet, setHalfSheet, beverageSheet }) {
...
@media print {
  ...
  <div class="page">${simpleHtml('영양성분표 — 음료', beverageSheet)}</div>
