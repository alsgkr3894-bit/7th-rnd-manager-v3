import { asDisplayText, buildLegacyToppingRows, buildToppingMasterRows } from '../_utils.js';
...
export function buildToppingSheet({
  ...
  const masterRows = buildToppingMasterRows(toppings, toppingAllergenMap, toppingOrder, nameOverrides);
  const seen = new Set(
    masterRows
