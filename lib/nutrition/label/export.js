...
export async function exportNutritionLabelToExcel({ pizzaSheet, pizzaSliceSheet = [], toppingSheet, sideSheet, setHalfSheet, beverageSheet }) {
  ...
  pizzaSliceSheet.forEach(({ menuName, rows }) => {
    rows.forEach(r => {
      wsSliceRows.push([
        menuName, r.crustLabel, r.side, r.slice, r.servingLabel,
        r.weight, r.kcal, r.sugar, r.protein, r.satFat, r.sodium,
        r.allergen,
      ]);
    });
