...
export async function exportNutritionLabelToExcel({
  ...
  // ── 시트2: 사이드·파스타 ──────────────────────────────────────
  const ws2Rows = [['제품 영양성분표 — 사이드·파스타'], ['메뉴명', ...HEADERS, '함유알레르기']];
  ...
  appendSheet(wb, XLSX, ws2Rows, '사이드·파스타', [24, 8, 8, 8, 8, 8, 8, 40]);

  // ── 시트3: 추가토핑 ──────────────────────────────────────────
  const ws3Rows = [['제품 영양성분표 — 추가토핑'], ['메뉴명', ...HEADERS, '함유알레르기']];
  ...
  appendSheet(wb, XLSX, ws3Rows, '추가토핑', [24, 8, 8, 8, 8, 8, 8, 40]);
  ...
  XLSX.writeFile(wb, withDownloadDateSuffix('제품 영양성분표.xlsx'));
}
