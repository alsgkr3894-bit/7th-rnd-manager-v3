 ...
 */
/**
 * @returns {Promise<Array<{ingredient: object, nutritionSnapshot: object|null}>>}
 */
 ...
 * @param {number} id
 * @returns {Promise<{ingredient: object, nutritionSnapshot: object|null}|null>}
 */
export async function deleteIngredient(id) {
  ...
  const nutritionSnapshot = target.productCode
    ? await import('@/lib/nutrition/values/store')
        .then(m => m.getIngredientValueByCode(target.productCode))
        .catch(() => null)
    : null;
  ...
  return { ingredient: target, nutritionSnapshot };
}
