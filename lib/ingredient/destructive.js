 ...
 * @returns {Promise<{ingredient: object, allergenLinkCount: number}|null>}
 */
export async function previewIngredientDelete(id) {
  ...
  return { ingredient, allergenLinkCount };
}
 ...
 * @returns {Promise<{ingredient: object, cascadeErrors: Array<object>, deletedAllergenLinks: Array<object>}|null>}
 */
export async function deleteIngredient(id) {
  ...
  return { ingredient: target, cascadeErrors, deletedAllergenLinks };
}
