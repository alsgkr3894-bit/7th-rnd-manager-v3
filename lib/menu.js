 ...
 *
 * 7개 섹션(개발 메모 / 판매 관리 / 메뉴 / 상품 관리 / 원가·영양 / 보고서센터 / 시스템)으로 그룹화.
    ...
    groups: [
      {
        ...
        iconKey: 'doc',
        children: [
          { id: 'menu-master', label: '메뉴 마스터', href: '/menu-master' },
          { id: 'menu-recipe-master', label: '레시피 마스터', href: '/cost/recipe-master' },
        ],
      },
    ],
  },
