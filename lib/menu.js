...
export const NAV_SECTIONS = [
  {
    ...
    groups: [
      {
        id: 'menu-sales', label: '메뉴 판매량', iconKey: 'chart', badge: 3,
        children: [
          ...
          { id: 'menu-sales-settings',     label: '설정',          href: '/menu-sales/settings' },
        ],
      },
    ],
  },
    ...
    groups: [
      {
        ...
        children: [
          ...
          { id: 'jette-shipment',      label: '범용 출고량',      href: '/jette/shipment' },
