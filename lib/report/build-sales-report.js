 ...
 *   discontinuedNameSet?: Set<string> }} params
...
export function buildSalesStats(
  normRows,
  { year, month, periodMode = 'month', scope, discontinuedNameSet }
) {
  ...
  const groupRanking = ranking.map((m, i) => {
    ...
    return {
      ...
      revenueDelta,
      revenueDeltaPct,
      discontinued: isDiscontinuedMenuName(m.name, discontinuedNameSet),
    };
  });
