...
export const ROUTE_CLASSIFICATIONS = Object.freeze([
  { route: '/', kind: ROUTE_KIND.SIDEBAR, runtime: [MAIN, CHINA4] },
  ...
  { route: '/menu-sales/rank-compare', kind: ROUTE_KIND.SIDEBAR, runtime: [MAIN] },
  ...
  { route: '/cost/margin', kind: ROUTE_KIND.SIDEBAR, runtime: [MAIN] },
  ...
  { route: '/note', kind: ROUTE_KIND.SIDEBAR, runtime: [MAIN, CHINA4, CHINA4_DIRECT] },
  ...
  { route: '/report', kind: ROUTE_KIND.SIDEBAR, runtime: [MAIN] },
