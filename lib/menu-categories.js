...
export function isMenuCategoryPizzaVariant(cat) {
  return typeof cat === 'string' && PIZZA_CATEGORY_VARIANTS.includes(cat.trim());
}

/** @deprecated 실제 정책 판정은 lib/menu-master/category-policy.js를 사용한다. */
export const isPizzaCategory = isMenuCategoryPizzaVariant;
