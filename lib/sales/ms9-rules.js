...
export const MS9_RULES = [
  ...
  { ruleId: 'rule_side_010', name: '세트 - 핫윙 4PCS+콘코울슬로', pattern: '핫윙 4PCS+콘코울슬로', matchType: 'exact', category: '세트메뉴', groupName: '사이드+콘코울슬로', detailName: '핫윙4PCS+콘코울슬로' },
  ...
  { ruleId: 'rule_side_013', name: '세트 - 치킨 바사삭 6PCS+콘코울슬로', pattern: '치킨 바사삭 6PCS+콘코울슬로', matchType: 'exact', category: '세트메뉴', groupName: '사이드+콘코울슬로', detailName: '치킨바사삭6PCS+콘코울슬로' },
  { ruleId: 'rule_side_014', name: '세트 - 치킨 바사삭 12PCS+콘코울슬로', pattern: '치킨 바사삭 12PCS+콘코울슬로', matchType: 'exact', category: '세트메뉴', groupName: '사이드+콘코울슬로', detailName: '치킨바사삭12PCS+콘코울슬로' },
