...
export const MS9_RULES = [
  ...
  // 피자+사이드세트 (단순 합산, 11개)
  { ruleId: 'rule_set_010', name: '세트메뉴 - 슈퍼콤비네이션 L+스파게티',      pattern: '슈퍼콤비네이션 피자 L+스파게티',      matchType: 'exact', category: '세트메뉴', groupName: '피자+사이드세트', detailName: '피자+사이드세트' },
  { ruleId: 'rule_set_011', name: '세트메뉴 - 샘스테이크 L+스파게티',          pattern: '샘스테이크 피자 L+스파게티',          matchType: 'exact', category: '세트메뉴', groupName: '피자+사이드세트', detailName: '피자+사이드세트' },
  { ruleId: 'rule_set_012', name: '세트메뉴 - 체다골드포테이토 L+스파게티',    pattern: '체다골드포테이토 피자 L+스파게티',    matchType: 'exact', category: '세트메뉴', groupName: '피자+사이드세트', detailName: '피자+사이드세트' },
  { ruleId: 'rule_set_013', name: '세트메뉴 - 칠리크림불갈비 L+스파게티',      pattern: '칠리크림불갈비 피자 L+스파게티',      matchType: 'exact', category: '세트메뉴', groupName: '피자+사이드세트', detailName: '피자+사이드세트' },
  { ruleId: 'rule_set_014', name: '세트메뉴 - 칠리크림불갈비 R+스파게티',      pattern: '칠리크림불갈비 피자 R+스파게티',      matchType: 'exact', category: '세트메뉴', groupName: '피자+사이드세트', detailName: '피자+사이드세트' },
  { ruleId: 'rule_set_015', name: '세트메뉴 - 페페로니 L+스파게티',            pattern: '페페로니 피자 L+스파게티',            matchType: 'exact', category: '세트메뉴', groupName: '피자+사이드세트', detailName: '피자+사이드세트' },
  { ruleId: 'rule_set_016', name: '세트메뉴 - 고구마 L+스파게티',              pattern: '고구마 피자 L+스파게티',              matchType: 'exact', category: '세트메뉴', groupName: '피자+사이드세트', detailName: '피자+사이드세트' },
  { ruleId: 'rule_set_017', name: '세트메뉴 - 오리지널 피자+스파게티',         pattern: '오리지널 피자+스파게티',              matchType: 'exact', category: '세트메뉴', groupName: '피자+사이드세트', detailName: '피자+사이드세트' },
  { ruleId: 'rule_set_018', name: '세트메뉴 - 오리지널 피자+떡볶이',           pattern: '오리지널 피자+떡볶이',                matchType: 'exact', category: '세트메뉴', groupName: '피자+사이드세트', detailName: '피자+사이드세트' },
  { ruleId: 'rule_set_019', name: '세트메뉴 - 오리지널 피자+치킨바사삭',       pattern: '오리지널 피자+치킨바사삭',            matchType: 'exact', category: '세트메뉴', groupName: '피자+사이드세트', detailName: '피자+사이드세트' },
  { ruleId: 'rule_set_020', name: '세트메뉴 - 스파게티+사이드 세트',           pattern: '스파게티+사이드 세트',                matchType: 'exact', category: '세트메뉴', groupName: '피자+사이드세트', detailName: '피자+사이드세트' },

  // 1인피자세트 (단순 합산, 9개)
  { ruleId: 'rule_set_030', name: '세트메뉴 - 더블치즈 P+스파게티',            pattern: '더블치즈 피자 P+스파게티',           matchType: 'exact', category: '세트메뉴', groupName: '1인피자세트', detailName: '1인피자세트' },
  { ruleId: 'rule_set_031', name: '세트메뉴 - 페페로니 P+스파게티',            pattern: '페페로니 피자 P+스파게티',           matchType: 'exact', category: '세트메뉴', groupName: '1인피자세트', detailName: '1인피자세트' },
  { ruleId: 'rule_set_032', name: '세트메뉴 - 고르곤졸라 P+스파게티',          pattern: '고르곤졸라 피자 P+스파게티',         matchType: 'exact', category: '세트메뉴', groupName: '1인피자세트', detailName: '1인피자세트' },
  { ruleId: 'rule_set_033', name: '세트메뉴 - 1인 피자 세트',                  pattern: '1인 피자 세트',                       matchType: 'exact', category: '세트메뉴', groupName: '1인피자세트', detailName: '1인피자세트' },
  { ruleId: 'rule_set_034', name: '세트메뉴 - 1인 피자+스파게티 세트',         pattern: '1인 피자+스파게티 세트',              matchType: 'exact', category: '세트메뉴', groupName: '1인피자세트', detailName: '1인피자세트' },
  { ruleId: 'rule_set_035', name: '세트메뉴 - 1인 반반 피자+스파게티 세트',    pattern: '1인 반반 피자+스파게티 세트',         matchType: 'exact', category: '세트메뉴', groupName: '1인피자세트', detailName: '1인피자세트' },
  { ruleId: 'rule_set_036', name: '세트메뉴 - 1인 피자+핫윙 세트',             pattern: '1인 피자+핫윙 세트',                  matchType: 'exact', category: '세트메뉴', groupName: '1인피자세트', detailName: '1인피자세트' },
  { ruleId: 'rule_set_037', name: '세트메뉴 - 더블치즈 P+흑미크림 찰치즈볼',   pattern: '더블치즈 피자 P+흑미크림 찰치즈볼',   matchType: 'exact', category: '세트메뉴', groupName: '1인피자세트', detailName: '1인피자세트' },
  { ruleId: 'rule_set_038', name: '세트메뉴 - 하와이안 P+떡볶이',              pattern: '하와이안 피자 P+떡볶이',              matchType: 'exact', category: '세트메뉴', groupName: '1인피자세트', detailName: '1인피자세트' },
