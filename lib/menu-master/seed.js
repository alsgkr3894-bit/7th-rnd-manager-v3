...
const SEED_ENTRIES = [
  ...
  // ── 음료 — 코카콜라 제로 (D-CZ) ─────────────────────────────
  {
    menuCode: 'D-CZ-001-355',
    category: '음료',
    subCategory: '코카콜라 제로',
    menuName: '코카콜라제로355ml',
    size: null,
    price: 1600,
    displayOrder: 8020,
  },
  {
    menuCode: 'D-CZ-001-500',
    category: '음료',
    subCategory: '코카콜라 제로',
    menuName: '코카콜라제로500ml',
    size: null,
    price: 1800,
    displayOrder: 8021,
  },
  {
    menuCode: 'D-CZ-001-1250',
    category: '음료',
    subCategory: '코카콜라 제로',
    menuName: '코카콜라제로1.25L',
    size: null,
    price: 2500,
    displayOrder: 8022,
  },
  ...
  // 치즈크러스트·골드스윗은 추가 요금이 사이즈별로 달라(L 5,000 / R 4,000) 피자처럼 L/R 두 행.
  {
  ...
  {
    menuCode: 'OPT-EDGE-003-L',
    category: '엣지',
    subCategory: '도우옵션',
    menuName: '골드스윗 크러스트 L',
    size: 'L',
    price: 5000,
    displayOrder: 9030,
  },
  {
    menuCode: 'OPT-EDGE-003-R',
    category: '엣지',
    subCategory: '도우옵션',
    menuName: '골드스윗 크러스트 R',
    size: 'R',
    price: 4000,
    displayOrder: 9031,
  },
...
export async function seedMenuMaster() {
  await assertActiveAdmin('메뉴마스터 시드');
