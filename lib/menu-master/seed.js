 ...
 *   P-ONE-001-ONE  1인피자 / 씬도우 전용 / 001 / ONE
...
const SEED_ENTRIES = [
  ...
  // ── 1인피자 (P-ONE) ───────────────────────────────────────────
  { menuCode: 'P-ONE-001-ONE', category: '1인피자', subCategory: '씬도우 전용', menuName: '하와이안 피자',   size: '단품', displayOrder: 5010 },
  { menuCode: 'P-ONE-002-ONE', category: '1인피자', subCategory: '씬도우 전용', menuName: '페페로니 피자',   size: '단품', displayOrder: 5020 },
  { menuCode: 'P-ONE-003-ONE', category: '1인피자', subCategory: '씬도우 전용', menuName: '더블치즈 피자',   size: '단품', displayOrder: 5030 },
  { menuCode: 'P-ONE-004-ONE', category: '1인피자', subCategory: '씬도우 전용', menuName: '고르곤졸라 피자', size: '단품', displayOrder: 5040 },
  ...
  // ── 사이드 — 스파게티 (S-SPG) ────────────────────────────────
  { menuCode: 'S-SPG-001', category: '사이드', subCategory: '스파게티', menuName: '쉬림프 아라비아따 스파게티', size: '단품', price: 8500, displayOrder: 7010 },
  { menuCode: 'S-SPG-002', category: '사이드', subCategory: '스파게티', menuName: '오븐 스파게티',              size: '단품', price: 7700, displayOrder: 7020 },

  // ── 사이드 — 떡볶이 (S-TBK) ──────────────────────────────────
  { menuCode: 'S-TBK-001', category: '사이드', subCategory: '떡볶이', menuName: '오븐 치즈떡볶이', size: '단품', price: 6500, displayOrder: 7030 },

  // ── 사이드 — 치킨 (S-CHK) ────────────────────────────────────
  { menuCode: 'S-CHK-001', category: '사이드', subCategory: '치킨', menuName: '치킨바사삭12PCS',  size: '단품', price: 6900, displayOrder: 7040 },
  { menuCode: 'S-CHK-002', category: '사이드', subCategory: '치킨', menuName: '치킨바사삭6PCS',   size: '단품', price: 3900, displayOrder: 7041 },
  { menuCode: 'S-CHK-003', category: '사이드', subCategory: '치킨', menuName: '핫윙4PCS',         size: '단품', price: 3900, displayOrder: 7050 },
  { menuCode: 'S-CHK-004', category: '사이드', subCategory: '치킨', menuName: '그릴닭다리살3PCS', size: '단품', price: 4200, displayOrder: 7060 },

  // ── 사이드 — 튀김 (S-FRY) ────────────────────────────────────
  { menuCode: 'S-FRY-001', category: '사이드', subCategory: '튀김', menuName: '통통새우링4PCS', size: '단품', price: 3500, displayOrder: 7070 },

  // ── 사이드 — 스낵 (S-SNK) ────────────────────────────────────
  { menuCode: 'S-SNK-001', category: '사이드', subCategory: '스낵', menuName: '흑미크림참치즈볼5PCS', size: '단품', price: 4900, displayOrder: 7080 },
  { menuCode: 'S-SNK-002', category: '사이드', subCategory: '스낵', menuName: '시나몬츄러스4PCS',     size: '단품', price: 3600, displayOrder: 7090 },

  // ── 사이드 — 샐러드 (S-SLD) ──────────────────────────────────
  { menuCode: 'S-SLD-001', category: '사이드', subCategory: '샐러드', menuName: '콘코울슬로', size: '단품', price: 2700, displayOrder: 7100 },

  // ── 사이드 — 피클류 (S-PKL) ──────────────────────────────────
  { menuCode: 'S-PKL-001', category: '사이드', subCategory: '피클류', menuName: '피클',       size: '단품', price: 900,  displayOrder: 7110 },
  { menuCode: 'S-PKL-002', category: '사이드', subCategory: '피클류', menuName: '할라피뇨팩', size: '단품', price: 1000, displayOrder: 7120 },

  // ── 소스 (S-SAU) — 별도 카테고리 ────────────────────────────
  { menuCode: 'S-SAU-001', category: '소스', subCategory: '소스추가', menuName: '갈릭디핑소스',   size: '단품', price: 200, displayOrder: 7200 },
  { menuCode: 'S-SAU-002', category: '소스', subCategory: '소스추가', menuName: '스위트칠리소스', size: '단품', price: 200, displayOrder: 7210 },
  { menuCode: 'S-SAU-003', category: '소스', subCategory: '소스추가', menuName: '핫소스',         size: '단품', price: 100, displayOrder: 7220 },
  { menuCode: 'S-SAU-004', category: '소스', subCategory: '소스추가', menuName: '꿀',             size: '단품', price: 500, displayOrder: 7230 },

  // ── 음료 — 코카콜라 (D-CC) ───────────────────────────────────
  { menuCode: 'D-CC-001-355',  category: '음료', subCategory: '코카콜라', menuName: '코카콜라355ml',   size: '단품', price: 1600, displayOrder: 8010 },
  { menuCode: 'D-CC-001-500',  category: '음료', subCategory: '코카콜라', menuName: '코카콜라500ml',   size: '단품', price: 1800, displayOrder: 8011 },
  { menuCode: 'D-CC-001-1250', category: '음료', subCategory: '코카콜라', menuName: '코카콜라1.25L',  size: '단품', price: 2500, displayOrder: 8012 },

  // ── 음료 — 코카콜라 제로 (D-CZ) ─────────────────────────────
  { menuCode: 'D-CZ-001-355',  category: '음료', subCategory: '코카콜라 제로', menuName: '코카콜라제로355ml',  size: '단품', price: 1600, displayOrder: 8020 },
  { menuCode: 'D-CZ-001-500',  category: '음료', subCategory: '코카콜라 제로', menuName: '코카콜라제로500ml',  size: '단품', price: 1800, displayOrder: 8021 },
  { menuCode: 'D-CZ-001-1250', category: '음료', subCategory: '코카콜라 제로', menuName: '코카콜라제로1.25L', size: '단품', price: 2500, displayOrder: 8022 },

  // ── 음료 — 스프라이트 (D-SPR) ────────────────────────────────
  { menuCode: 'D-SPR-001-355',  category: '음료', subCategory: '스프라이트', menuName: '스프라이트355ml', size: '단품', price: 1600, displayOrder: 8030 },
  { menuCode: 'D-SPR-001-500',  category: '음료', subCategory: '스프라이트', menuName: '스프라이트500ml', size: '단품', price: 1800, displayOrder: 8031 },
  { menuCode: 'D-SPR-001-1500', category: '음료', subCategory: '스프라이트', menuName: '스프라이트1.5L', size: '단품', price: 2500, displayOrder: 8032 },

  // ── 엣지/도우 옵션 (OPT-EDGE) ────────────────────────────────
  { menuCode: 'OPT-EDGE-001', category: '엣지', subCategory: '도우옵션', menuName: '석쇠도우',       size: '단품', price: 0,    displayOrder: 9010 },
  { menuCode: 'OPT-EDGE-002', category: '엣지', subCategory: '도우옵션', menuName: '치즈크러스트',   size: '단품', price: 4000, displayOrder: 9020 },
  { menuCode: 'OPT-EDGE-003', category: '엣지', subCategory: '도우옵션', menuName: '골드스윗 크러스트', size: '단품', price: 4000, displayOrder: 9030 },
];
