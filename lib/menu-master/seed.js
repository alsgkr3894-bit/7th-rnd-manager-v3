...
const SEED_ENTRIES = [
  ...
  // ── 1인피자 (P-ONE) ───────────────────────────────────────────
  { menuCode: 'P-ONE-001-ONE', category: '1인피자', subCategory: '씬도우 전용', menuName: '하와이안 피자',   size: null, displayOrder: 5010 },
  { menuCode: 'P-ONE-002-ONE', category: '1인피자', subCategory: '씬도우 전용', menuName: '페페로니 피자',   size: null, displayOrder: 5020 },
  { menuCode: 'P-ONE-003-ONE', category: '1인피자', subCategory: '씬도우 전용', menuName: '더블치즈 피자',   size: null, displayOrder: 5030 },
  { menuCode: 'P-ONE-004-ONE', category: '1인피자', subCategory: '씬도우 전용', menuName: '고르곤졸라 피자', size: null, displayOrder: 5040 },
