...
import { loadMenuRecipeMaps as loadCanonicalMenuRecipeMaps } from '@/lib/menu-recipes';
...
export function summarizeMenuRecipe(menu, recipe, unitPriceMap = new Map(), options = {}) {
  ...
  const commonComponents = buildAppliedRecipeGroupComponents(menu, options.recipeGroups);
