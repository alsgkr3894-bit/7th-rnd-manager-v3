/* global React, Icon, Pages, fmtKRW, fmtShort, AreaChart */
  ...
  return (
    <main className="main">
      <PageHeader
        ...
        actions={<button className="btn"><Icon.download style={{width:14, height:14}}/>양식 다운로드</button>}
      />
      ...
      {stage !== "preview" ? (
        <div className={"card dropzone " + (drag ? "drag" : "")}
          ...
          onDrop={e=>{e.preventDefault(); setDrag(false); setStage("validating"); setTimeout(()=>setStage("preview"), 800);}}
          onClick={()=>{ setStage("validating"); setTimeout(()=>setStage("preview"), 800); }}
        >
