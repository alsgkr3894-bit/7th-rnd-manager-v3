...
/* ============================================================
   Donut Ring  (스윕 애니메이션 포함)
============================================================ */
function Donut({ items, size = 140, thickness = 14 }) {
      ...
      {items.map((it, i) => {
        ...
        return (
          <circle key={i} cx={size/2} cy={size/2} r={r} fill="none"
            stroke={it.color} strokeWidth={thickness} strokeLinecap="butt"
...
Object.assign(window, { Sidebar, TopBar, CommandPalette, Sparkline, AreaChart, Donut, fmtKRW, fmtShort, useCountUp });
