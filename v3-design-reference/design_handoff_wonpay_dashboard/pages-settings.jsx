    ...
    <main className="main">
      <PageHeader
        ...
        actions={<>
          ...
          <button className="btn primary"><Icon.upload style={{width:14, height:14}}/>지금 백업 실행</button>
        </>}
      />
              ...
              <tr key={b.id}>
                ...
                <td>
                  <div style={{display:"flex", gap:6, justifyContent:"flex-end"}}>
                    <button className="btn sm" disabled={b.status !== "성공"}>
                      <Icon.download style={{width:12, height:12}}/>다운로드
                    </button>
                    <button className="btn sm" disabled={b.status !== "성공"}>복원</button>
      ...
      <div className="restore-grid">
        ...
        <div className="card">
          ...
          <div style={{display:"flex", gap:8, marginTop:16}}>
            ...
            <button className="btn primary block" style={{background: mode==="apply" ? "var(--negative)" : undefined, borderColor: mode==="apply" ? "var(--negative)" : undefined}}>
