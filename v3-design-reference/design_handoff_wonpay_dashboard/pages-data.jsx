        ...
        <table className="data-table">
          <thead>
            <tr>
              ...
              <th style={{width:140, textAlign:"right"}} onClick={()=>toggleSort("qty")} className="sortable">
                판매량 <SortIco active={sortKey==="qty"} dir={sortDir}/>
              </th>
              <th style={{width:140, textAlign:"right"}} onClick={()=>toggleSort("share")} className="sortable">
                {cat === "all" ? "판매 비중" : `${cat} 내 비중`} <SortIco active={sortKey==="share"} dir={sortDir}/>
              </th>
              <th style={{width:110, textAlign:"right"}} onClick={()=>toggleSort("costRate")} className="sortable">
