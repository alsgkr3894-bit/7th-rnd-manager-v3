/* global React, Icon, Sidebar, TopBar, Sparkline, AreaChart, Donut, fmtKRW, fmtShort, useCountUp */
const { useState: useStateD } = React;

function Dashboard({ onOpenUpload, onOpenNote }) {
        ...
        <div className="card status-card">
          ...
          <div className="risk-list">
            {[
              ...
              <button className="risk-row" key={i}>
