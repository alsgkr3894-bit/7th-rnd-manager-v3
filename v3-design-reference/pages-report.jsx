/* global React, Icon, Pages, fmtKRW, fmtShort, Sparkline, AreaChart, showToast */
  ...
  return (
    <main className="main">
      <PageHeader
        ...
        sub={sub}
        actions={<>
          <button className="btn" onClick={()=>showToast("임시 저장됐어요", "ok")}><Icon.doc style={{width:14, height:14}}/>임시 저장</button>
