...
export const Icon = {
  ...
  alert: p => (
    <svg viewBox="0 0 24 24" {...stroke} {...p}>
      ...
      <path d="m11 3-9 16a1 1 0 0 0 .9 1.5h18.2A1 1 0 0 0 22 19L13 3a1 1 0 0 0-2 0Z" />
    </svg>
  ),
  check: p => (
    <svg viewBox="0 0 24 24" {...stroke} {...p}>
  ...
  starFill: p => (
    <svg viewBox="0 0 24 24" {...stroke} fill="currentColor" {...p}>
      <path d="M12 3.5l2.6 5.27 5.82.85-4.21 4.1.99 5.78L12 16.77l-5.2 2.73.99-5.78-4.21-4.1 5.82-.85L12 3.5Z" />
    </svg>
  ),
};
