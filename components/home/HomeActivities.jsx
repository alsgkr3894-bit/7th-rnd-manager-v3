...
const ACT_META = {
  'upload-sales': {
    ico: <Icon.upload style={{ width: 18, height: 18 }} />,
  ...
  note: {
    ico: <Icon.beaker style={{ width: 18, height: 18 }} />,
    color: 'var(--accent)',
    bg: 'var(--accent-soft)',
  },
};
...
function activityHref(type) {
  switch (type) {
    case 'upload-sales':
      return '/menu-sales/upload';
    case 'upload-jette':
      return '/jette/price-compare';
    case 'note':
      return '/note';
    default:
      return null;
      ...
      <div className="card">
        <div className="card-header">
          <div>
            ...
            <div className="card-sub">업로드 · 노트</div>
          </div>
        </div>
            ...
            {safeActivities.map((a, i) => {
              ...
              return (
                <button
                  ...
                  style={{
                    gridTemplateColumns: '36px 1fr 80px 16px',
                    padding: '12px 4px',
                    ...rowButtonStyle,
                ...
                >
                  ...
                  <div className="acct" style={{ fontSize: 12, textAlign: 'right' }}>
