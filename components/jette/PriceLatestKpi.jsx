...
function formatUploadedAt(value) {
  ...
  const raw = typeof value === 'string' || typeof value === 'number' || value instanceof Date
    ? value
    : asDisplayText(value);
    ...
    <div className="hero-row" style={{marginTop:16}}>
      ...
      <div className="card kpi-card">
        <div>
          ...
          <div className="value num">{formatNumber(safeRows.length)}<span className="unit">개</span></div>
          <div className="trend">
