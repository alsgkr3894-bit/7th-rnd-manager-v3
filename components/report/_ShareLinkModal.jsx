...
import { ReportModalShell } from './_ReportModalShell';
      ...
      {!linkCreated ? (
        <>
          ...
          <div className="share-section">
            ...
            <div className="share-sub" style={{ marginTop: 4 }}>
              보고서에 "공유 복사본" 표시
            </div>
          </div>
          <div className="share-section">
        ...
        <>
          <div
            ...
            style={{ background: 'var(--surface-2)', padding: 12, borderRadius: 8 }}
          >
            <div className="share-sub" style={{ fontSize: 11, marginBottom: 8 }}>
              공유 링크 복사
            </div>
          ...
          <div style={{ display: 'flex', gap: 8, marginTop: 24 }}>
            <button className="btn" onClick={() => setLinkCreated(false)}>
              다시 생성
            </button>
