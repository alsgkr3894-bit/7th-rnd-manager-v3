...
export function PersonalDetailEditModal({ menu, initial, onSave, onClose }) {
  ...
  const totalCost = personalTotalCost({ components });
  const costRate = (menu.price && totalCost > 0) ? (totalCost / menu.price * 100) : null;
  const listId = 'personal-detail-ing-options';
