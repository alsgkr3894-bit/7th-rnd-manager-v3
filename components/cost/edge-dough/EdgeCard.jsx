    ...
    <div className="card" style={{padding:'14px 18px', display:'flex', alignItems:'center', gap:14}}>
      <div style={{flex:1, minWidth:0}}>
        <div style={{display:'flex', alignItems:'center', gap:8, flexWrap:'wrap'}}>
          <span style={{fontWeight:700, fontSize:15}}>{edge.edgeType}{sizeLabel}</span>
          <span style={{
      ...
      <div style={{textAlign:'right', minWidth:120}}>
        ...
        <div style={{fontSize:18, fontWeight:800, color: total > 0 ? 'var(--text-1)' : 'var(--text-4)', lineHeight:1.2}}>
          {total > 0 ? <>{formatNumber(total)}<span style={{fontSize:12, fontWeight:600, marginLeft:2}}>원</span></> : '—'}
        </div>
      </div>
