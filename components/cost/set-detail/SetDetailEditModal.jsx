...
export function SetDetailEditModal({ menu, initial, onSave, onClose }) {
  ...
  const totalCost = setTotalCost({ components });
  const costRate = (menu.price && totalCost > 0) ? (totalCost / menu.price * 100) : null;
  const listId = 'set-detail-ing-options';
    ...
    <div style={{
      ...
      <div className="card" style={{
        ...
        <div style={{
          ...
          1차 구현 — 식자재·포장재 직접 입력. 기존 메뉴 원가 참조는 다음 단계에서 추가됩니다.
        </div>
