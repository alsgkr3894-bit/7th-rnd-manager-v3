...
export function MenuPriceRow({
  ...
  return (
    <tr>
      ...
      <InlineEditCell value={r.menuCode || ''} required onSave={value => inlineSave(r, { menuCode: value })} />
      <InlineEditCell
        value={r.category || ''}
      ...
      <td style={{textAlign:'center'}}>
        {deletePending ? (
          <span style={{display:'flex', gap:3, justifyContent:'center'}}>
            ...
            <button className="btn sm" style={{fontSize:11}} onClick={deleteCancel}>취소</button>
          </span>
        ) : (
